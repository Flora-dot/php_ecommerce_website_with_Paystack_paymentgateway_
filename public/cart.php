               ...
               <div class="pt-4">
                    ...
                    <div class="row price-details">
                        ...
                        <div class="check-out text-center w-100 mt-2 mb-2">
                            <button type="button" class="btn text-white" style="background-color: #95C41F;" data-bs-toggle="modal" data-bs-target="#exampleModal"><i class="fa fa-credit-card"></i> Proceed to checkout</button>
                        </div>
                    </div>
               </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                   ...
                   <button onclick="paywithpaystack()" class="btn text-white" style="background-color: #95C41F;">Buy Now</button>
                   </div>
                </div>
